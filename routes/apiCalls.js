...
//              const result  =  await StudentResult.findOne({class:sClass, term:term, studentId:id, section:sSection})
//                    if(result){
//                      res.status(200).json({msg:"result uploaded"})
//                     return;
//                    }
...
//             const student4 = await StudentResult.find({studentId: studentId})
